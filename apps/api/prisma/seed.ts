...
async function main() {
        ...
        create: [
          {
            ...
            departmentIdSnapshot: financeDepartment.id,
          ...
          },
          {
            ...
            scheduleIdSnapshot: standardSchedule.id,
            scheduleNameSnapshot: standardSchedule.name,
            departmentIdSnapshot: hrDepartment.id,
            employeeTypeSnapshot: EmployeeType.FULL_TIME,
          },
        ],
      },
  ...
  // Seed Prior-Month Paid Payrun (February 2026) for reporting demonstration
  await prisma.payrun.upsert({
    where: { payrunNumber: 'PAY/2026/000000' },
    update: {},
    create: {
      payrunNumber: 'PAY/2026/000000',
      name: `Payrun - ${regularStructure.name} - 2026-02-01 to 2026-02-28`,
      salaryStructureId: regularStructure.id,
      salaryStructureName: regularStructure.name,
      ...
      status: 'PAID',
      createdByUserId: adminUser!.id,
      computedByUserId: adminUser!.id,
      computedAt: new Date('2026-02-28T10:00:00.000Z'),
      validatedByUserId: adminUser!.id,
      validatedAt: new Date('2026-02-28T12:00:00.000Z'),
      paidByUserId: adminUser!.id,
      paidAt: new Date('2026-02-28T14:00:00.000Z'),
      payslips: {
        create: [
          {
            employeeId: aarav.id,
            ...
            status: 'PAID',
            monthlyWage: aaravContract.monthlyWage,
            basicAmount: new Prisma.Decimal(45000),
            allowanceAmount: new Prisma.Decimal(15000),
            grossAmount: new Prisma.Decimal(60000),
            deductionAmount: new Prisma.Decimal(2500),
            netAmount: new Prisma.Decimal(57500),
            employeeNumberSnapshot: aarav.employeeNumber,
            employeeNameSnapshot: 'Aarav Mehta',
            departmentNameSnapshot: 'Finance',
            departmentIdSnapshot: financeDepartment.id,
          ...
          },
          {
            ...
            status: 'PAID',
            monthlyWage: priyaContract.monthlyWage,
            basicAmount: new Prisma.Decimal(65000),
            allowanceAmount: new Prisma.Decimal(20000),
            grossAmount: new Prisma.Decimal(85000),
            deductionAmount: new Prisma.Decimal(3500),
            netAmount: new Prisma.Decimal(81500),
            employeeNumberSnapshot: priya.employeeNumber,
            employeeNameSnapshot: 'Priya Sharma',
            departmentNameSnapshot: 'Human Resources',
            departmentIdSnapshot: hrDepartment.id,
